...
<center><b>RECHERCHE COURRIER ENTRANT ARCHIVE</b><br><br>
<form name = rechercheAvanceeForm method = POST action = archiveEntrant.php>
<table align = center>
<tr>
<td>libelle</td>
...
echo "<td bgcolor = ".$couleur.">".$ligne['idCourrier']."</td><td bgcolor = ".$couleur.">".$ligne['libelle']."</td><td bgcolor = ".$couleur.">".$tmp."</td><td bgcolor=".$couleur."><a href=archiveEntrantHistorique.php?idCourrier=".$ligne['idCourrier'].">historique</a></td></tr>";
}//fin while
echo "</table>";

echo "<br><a href = archiveEntrant.php>nouvelle recherche</a>";
