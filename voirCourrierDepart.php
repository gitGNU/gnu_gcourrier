...
$re = "select max(id)as id from courrier where type = 2;";
...
?>
<form method = POST action=voirCourrierAfficheDepart.php>
...
while( $ligne = mysql_fetch_array($resultatEntrant) ){
	...
	echo"<td bgcolor=".$couleur."><a href=cheminDepart.php?idCourrier=".$idCourrier."&affiche=".$nbAffiche.">historique</a></td>";

	if(strcmp($_SESSION['login'] , 'admin') != 0){
		echo"<td bgcolor=".$couleur."><a href=transmettreDepart.php?idCourrier=".$idCourrier."&affiche=".$nbAffiche.">transmettre</a></td>";
...
if(mysql_num_rows($resultatEntrant) == $nbAffiche){
	echo "<a href = voirCourrierDepart.php?id=".$idTmp."&nbAffiche=".$nbAffiche."><b>page suivante</b></a></center>";
}
