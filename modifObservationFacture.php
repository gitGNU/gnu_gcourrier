...
$requete = "select observation from facture where id = ".$idCourrier.";";
...
<form method=POST action=modifObservationFacture.php>
<?php
echo"<center>";
echo"observation<br>";
...
header("LOCATION: invoice_list.php?id=$idCourrier#result");
}
?>
