...
echo"<center><div id= titre>Facture<br/><br/></div></center>";
...
//	echo "nbJours:".$ligne['nbJours'];
	...
	echo "<td bgcolor=".$couleur.">".$refFacture."</td>";
...
/*
	$requete ="SELECT service.libelle as libelle,
	...
	while ( $ligne = mysql_fetch_array($result) ){
		...
		$service = $ligne['libelle'];
		echo $service." / ";
	}
echo "'></img></font></center></a></td>";
*/
...
//		echo " fze ".$urgence." : ".$nbJours." :: ".$ligne['nbJours']."<br>";
		...
		if($urgence >= $nbJours)	
                   ...
                   echo "<td bgcolor=".$couleur."><center><img src=images/ok.png title=\"reste ".$nbJoursRestant." jours\"></img></center></td></tr>";
