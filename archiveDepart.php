...
<center><b>RECHERCHE COURRIER DEPART ARCHIVE</b><br><br>
<form name = rechercheAvanceeForm method = POST action = archiveDepart.php>
<table align = center>
<tr>
<td>libelle</td>
...
$from ="    FROM courrier ";
$where =" WHERE courrier.validite = 1 and courrier.type=2";
...
echo "<td bgcolor = ".$couleur.">".$ligne['idCourrier']."</td><td bgcolor = ".$couleur.">".$ligne['libelle']."</td><td bgcolor = ".$couleur.">".$tmp."</td><td bgcolor=".$couleur."><a href=archiveDepartHistorique.php?idCourrier=".$ligne['idCourrier'].">historique</a></td></tr>";
}//fin while
echo "</table>";

echo "<br><a href = archiveDepart.php>nouvelle recherche</a>";
