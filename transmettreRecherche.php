...
<div id=pageGd><br>
	...
	<form name = transmettreForm method = POST action = transmettreRecherche.php>
	<tr><td>service</td><td>
	<select name = service>
		<?php
	...
	<?php
	$requete = "Select observation from courrier where id = ".$idCourrier." and validite=0; ";
	$result = mysql_query( $requete ) or die ("erreur observation".mysql_error( ) );
...
<center><br>
<a href="javascript:history.go(-1)"> <b>retourner au resultat</b></a><br><br>
...
$requete="insert into estTransmis(dateTransmission,idCourrier,idService,danger) values('".date("Y-m-d")."','".$idCourrier."','".$service."',1);";
